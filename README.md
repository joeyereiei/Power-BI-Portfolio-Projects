...
This project analyzes a synthetic e-commerce orders dataset (30,000 orders, 41 columns) across three pages, each answering a different layer of business question:

- **Overview** — What's the current state of the business? Revenue, profit, return/cancellation rates, top categories and countries, customer base composition.
...
**Hataipon Pengkumma (Joy)** — Aspiring Data Analyst with a background in health data science at University of Exeter.

I build these projects to practice real-world data modeling and analysis.

**Let's connect:**
[LinkedIn](https://linkedin.com/in/hataipon-pengkumma-a44710337) · [Email](hataipon.peng@gmail.com) 
